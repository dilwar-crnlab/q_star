...
if typing.TYPE_CHECKING:
    from optical_rl_gym.envs.mod_optical_network_env import ModifiedOpticalNetworkEnv
...
def start_environment(env: "ModifiedOpticalNetworkEnv", steps: int) -> "ModifiedOpticalNetworkEnv":
    done = True
